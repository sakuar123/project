...
public class JwtUtil {
    ...
    public static String createJwt(Date expirationDate, PageData pageData) {
        ...
        String subject = pageData.getString(USER_NAME);
    ...
    private static JwtUser convertJwtUser(Claims claims) {
        ...
        jwtUser.setUserId(CommonsUtil.parseLong(claims.get("userId").toString()));
        jwtUser.setSubName(claims.getSubject());
        jwtUser.setExpTime(claims.getExpiration());
        jwtUser.setUserName(String.valueOf(claims.get(USER_NAME)));
        return jwtUser;
    }

    public static PageData buildClaims(Integer userId, String userName) {
        PageData pageData = new PageData();
        pageData.put(USER_NAME, userName);
